...
import { AccountId, BASE_TO_CONVERT, percentageToYocto } from "./utils";
 ...
 */
  @mutateState()
  addService(provider: AccountId, title: string, description: string, expiryDate: string): Service {
  ...
  subscribe(): Subscriber {
    ...
    let currentTimestamp: u64 = this._toMillisecond(context.blockTimestamp);
    let expiryTimestamp: u64 = currentTimestamp + this.calcSubDuration();
